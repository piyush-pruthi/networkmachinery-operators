...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	...
	case v1alpha1.SchemeGroupVersion.WithResource("networkperformancetests"):
		return &genericInformer{resource: resource.GroupResource(), informer: f.Networkmachinery().V1alpha1().NetworkPerformanceTests().Informer()}, nil
